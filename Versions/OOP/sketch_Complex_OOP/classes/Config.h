...
// Primary config, or defaults.
    ...
    #include "config.h"
#else
    #warning "Using Defaults: Copy config.sample.h to config.h and edit that to use your own settings"
...
#define CAM_NAME "HiIT Camera Server"
...
#define URL_HOSTNAME "HiIT-esp32-cam"
 ...
 */
/* Optionally change the AccessPoint ip address (default = 192.168.4.1) warning - IP addresses must be separated with commas (,) and not decimals (.) */
// #define AP_ADDRESS 192,168,4,1

/* Uncomment this to force the AccessPoint channel number, default = 1 */
// #define AP_CHAN 1

/* Port numbers for WebUI and Stream, 
 * defaults to 80 and 81. Uncomment and edit as appropriate
 */
// #define HTTP_PORT 80
// #define STREAM_PORT 81

/* Wifi Watchdog 
 * defines how long we spend waiting for a connection before retrying, and how often we check to see if we are still connected, milliseconds
 * You may wish to increase this if your WiFi is slow at conencting.
 */
// #define WIFI_WATCHDOG 15000

/* Over The Air
 * firmware updates can be disabled by uncommenting the folowing line. When enabled the device will advertise itself using the MDNS_NAME defined above
 */
// #define NO_OTA
...
/* Minimal frame duration in ms, used to limit max FPS. max_fps = 1000/min_frame_time */
...
/* Camera Hardware Selection - This is not optional */
